        ...
        diaReserva = +prompt("Ingrese el dia que quiere reservar");
            if ((Number.isInteger(diaReserva))&&(diaReserva <=days)){
                if (reservados.includes(diaReserva)){
                    ...
                    alert("Reserva confirmada para el día: " + +diaReserva + " de " +mesString + "\n\n A nombre de: " +Object.values(persona)[0] + " " +Object.values(persona)[1] + "\n Dirección: " +Object.values(persona)[3] + "\n Telefono: " + +Object.values(persona)[2] + "\n\n Gracias por su reserva");
